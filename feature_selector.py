...
from sklearn.metrics import accuracy_score, classification_report, plot_confusion_matrix, recall_score, f1_score, roc_auc_score, cohen_kappa_score
from sklearn.model_selection import train_test_split, cross_val_score, KFold, GridSearchCV, StratifiedKFold

from sklearn import preprocessing
from sklearn.preprocessing import LabelEncoder,LabelBinarizer, OneHotEncoder, MinMaxScaler,minmax_scale,MaxAbsScaler,StandardScaler,RobustScaler,Normalizer,QuantileTransformer
...
class FeatureSelector():
    ...
    def plot_unique(self):
        ...
        self.unique_stats.plot.hist(edgecolor = 'k', figsize = (10, 12))
