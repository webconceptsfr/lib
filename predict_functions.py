...
def prepareDataForFeatureCol(dataframeInput,label_name):
...
def predictModel( trainingDataframe,   label_name,  predict_dataframeInput  ):
    #--
    ...
    predict_df=[]
    predict_df = prepareData(predict_dataframeInput,label_name)
    #display(predict_dataframeInput)
    #display(predict_df)
    ...
    if predict_df.empty == True:
        ...
        #-- hyperparameters
        if label_name=="FTR":
            n_class = 3 ; batch_size = 196 ; momentum = 0.92 ; dropout=0.092 ; #mt = "model_large_L2Regul" ; regul=0.00001
            
            n_class = 3 ; batch_size = 226 ; momentum = 0.85 ; dropout=0.092 ; mt = "model_large_L2Regul" ; regul=0.000002 
            #feature_columns,train_df,valid_df= formatData(dataframeInput,label_name,0.9)

        elif label_name=="Team1Win" or label_name=="NotTeam1Win" :
            n_class = 1 ; batch_size = 196 ; momentum = 0.82 ; dropout=0.099 ;
        elif label_name=="Team2Win":
            n_class = 1 ; batch_size = 226 ; momentum = 0.85 ; dropout=0.097 ; mt = "model_large_L2Regul" ; regul=0.0000005 
            ...
            n_class = 1 ; batch_size = 256 ; momentum = 0.92 ; dropout=0.120 ; mt = "model_large_L1Regul" ; regul=1

        elif label_name=="Ov35":
            n_class = 1 ; batch_size = 226 ; momentum = 0.85 ; dropout=0.097 ; mt = "model_large_L2Regul" ; regul=0.000005 

        elif label_name=="Ov25":
            n_class = 1 ; batch_size = 185 ; momentum = 0.92 ; dropout=0.0924 ; mt = "model_mlarge_drop"
        elif label_name=="Ov15":
            n_class = 1 ; batch_size = 256 ; momentum = 0.92 ; dropout=0.096 ; mt = "model_large_L1Regul" ; regul=0.0001
        elif label_name=="LDEM":
            n_class = 1 ; batch_size = 256 ; momentum = 0.92 ; dropout=0.096 ; mt = "model_large_L1Regul" ; regul=0.0002
        #----
